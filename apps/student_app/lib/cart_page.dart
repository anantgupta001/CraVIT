...
import 'package:cravit_core/services/order_service.dart'; // Import OrderService
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) async {
    ...
    if (cart.items.isNotEmpty) {
      try {
        ...
        final vendorId = cart.items.first.shopName; // Assuming all items in cart are from the same vendor
